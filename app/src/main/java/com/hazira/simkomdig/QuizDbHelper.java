...
//    }
    ...
    private void fillQuestionsTable() {
        ...
        Question q20 = new Question("Untuk mengatur ukuran batas kertas  maka fitur yg digunakan","Orientation","Margins","Section Break","Gutter",3,1);addQuestion(q19);
        /*2. Excel*/
        Question q21 = new Question("Format dokumen berikut yang tidak bisa dibuat menggukan excel adalah",".docx",".xlsx",".xml",".html",1,2);addQuestion(q20);
        Question q22 = new Question("Untuk menyimpan dokumen excel yang sedang dibuka dengan nama baru maka digunakan fitur...","Save","Share","Save as","Share as",3,2);addQuestion(q21);
        Question q23 = new Question("Penulisan formula sederhana dibawah ini yang benar adalah ...","=A1*A2","A1+A2=","= A1:A2","A1/A2=",1,2);addQuestion(q22);
        Question q24 = new Question("Fitur excel yang digunakan untuk menampilkan visualisasi dari data adalah","Chart","Graph","Diagram","Sketch",1,2);addQuestion(q23);
        Question q25 = new Question("Pertemuan antara kolom dan baris pada Ms. Excel disbeut dengan...","Log","Row","Box","Cell",4,2);addQuestion(q24);
        /*3. Ebook*/
        ...
        Question q35 = new Question("untuk menampilkan slide yang sedang dipilih ke slide show maka digunakan shortcut...","Ctrl + F5","Alt + F5","Shift + ","Tab + F5",3,2);addQuestion(q31);
        /*5. Peta Minda*/
